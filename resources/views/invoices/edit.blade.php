...
@endif
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('update.invoices',$invoice->id) }}" method="post" enctype="multipart/form-data"
                        autocomplete="off">
                        {{ csrf_field() }}
                        {{-- 1 --}}
...
<script>
    $(document).ready(function() {
        $('select[name="Section"]').on('change', function() {
            ...
            if (SectionId) {
                $.ajax({
                    url: "{{ URL::to('invoices/getproducts') }}/" + SectionId,
                    type: "GET",
                    dataType: "json",
...
{{-- لحساب قيمه الضريبه المضافه و الاجملى شامل الضريبه --}}
    <script>
        function myFunction() {
