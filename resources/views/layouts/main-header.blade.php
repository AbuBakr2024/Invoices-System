				...
				<div class="container-fluid">
					<div class="main-header-left ">
						...
						<div class="main-header-center mr-3 d-sm-none d-md-none d-lg-block">
							<input class="form-control" placeholder="ابحث عن اى شى ...." type="search"> <button class="btn"><i class="fas fa-search d-none d-md-block"></i></button>
						</div>
					</div>
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
                                            ...
                                            <span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a href={{route('MarkAsRead_all.invoices')}}>تعين قراءة الكل</a></span>
										</div>
                                                                {{-- علشان هعمل كود ب اجكس هيعمل ريفريش كل خمس ثوانى --}}
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12" id="notifications_count">عدد الاشعارات غير المقروءه : {{auth()->user()->unreadNotifications->count()}}</p>
									...
									<div class="main-notification-list Notification-scroll">
										<a class="d-flex p-3 border-bottom" href="{{ route('edit.invoicesdetails',$notifications->data['id']) }}">
                                            ...
                                            <div class="mr-3">
                                                <h5 class="notification-label mb-1">
                                                    ...
                                                    {{$notifications->data['tittle']}}   {{$notifications->data['user']}}

                                                </h5>
												<div class="notification-subtext">    {{$notifications->created_at}}</div>
											</div>
                                            @else
                                            <div class="mr-3">
                                                <h5 class="notification-label mb-1">لا توجد اشعارات غير مقروءه</h5>
											</div>
                                            @endif
