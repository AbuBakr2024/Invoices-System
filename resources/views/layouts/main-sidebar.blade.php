			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
                  ...
                  <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can( 'قائمة الفواتير')
                        <li><a class="slide-item" href="{{ route('index.invoices') }}">قائمة الفواتير</a></li>
                        @endcan
                      ...
                      <li><a class="slide-item" href="{{ route('partial.invoices') }}">الفواتير المدفوعة جزئيا</a></li>
                      @endcan

                      <li><a class="slide-item" href="{{ route('archive.invoices') }}">الفواتير المتارشفه</a></li>
                  ...
                  @can('التقارير')
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            @can('تقرير الفواتير')
							<li><a class="slide-item" href="{{ route('index.report') }}">تقرير الفواتير</a></li>
                            @endcan
                            @can('تقرير العملاء')
							<li><a class="slide-item" href="{{ route('index.cust_report') }}">تقرير العملاء</a></li>
                            @endcan
						</ul>
					</li>
                  @endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ route('index.user') }}">قائمة المستخدمين</a></li>
                            @endcan

                            <li><a class="slide-item" href="{{ route('index.role') }}">صلاحيات المستخدمين</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            @can( 'الاقسام')
							<li><a class="slide-item" href="{{route('index.section')}}">الاقسام</a></li>
                            @endcan
                            @can('المنتجات')
							<li><a class="slide-item" href="{{ route('index.product') }}">المنتجات</a></li>
                            @endcan
						</ul>
					</li>
                    @endcan
